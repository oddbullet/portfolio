export function CSharp() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#512BD4" }}
    >
      C#
    </div>
  );
...
export function ExpressTag() {
  return (
    ...
    >
      <img src="https://cdn.simpleicons.org/express/FFFFFF?viewbox=auto&size=15" />
      Express.js
    </div>
  );
}

export function FirebaseTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#DD2C00" }}
    >
      <img src="https://cdn.simpleicons.org/firebase/FFFFFF?viewbox=auto&size=20" />
      Firebase
    </div>
  );
}
...
export function GithubAltTag() {
  return (
    <svg width="1.5rem" viewBox="0 0 640 640">
...
export function JavaTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#3A75B0" }}
    >
      Java
    </div>
  );
...
export function JSTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "black", backgroundColor: "#f7df1e" }}
    >
      <img src="https://cdn.simpleicons.org/javascript/000000?viewbox=auto&size=20" />
      JavaScript
    </div>
  );
}

export function KotlinTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#7F52FF" }}
    >
      <img src="https://cdn.simpleicons.org/kotlin/FFFFFF?viewbox=auto&size=20" />
      Kotlin
    </div>
  );
}
...
export function LinkTag() {
  return (
    <svg width="1.2rem" viewBox="0 0 640 640">
...
export function LinkedinTag() {}

export function MongoDBTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#47A248" }}
    >
      <img src="https://cdn.simpleicons.org/mongodb/FFFFFF?viewbox=auto&size=20" />
      MongoDB
    </div>
  );
}
...
export function NodeJSTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#5FA04E" }}
    >
      <img src="https://cdn.simpleicons.org/node.js/FFFFFF?viewbox=auto&size=20" />
      Node.js
    </div>
  );
}

export function PythonTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#3776AB" }}
    >
      <img src="https://cdn.simpleicons.org/python/FFFFFF?viewbox=auto&size=20" />
      Python
    </div>
  );
}
...
export function ReactTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "black", backgroundColor: "#61DAFB" }}
    >
      <img src="https://cdn.simpleicons.org/React/000000?viewbox=auto&size=20" />
      React
    </div>
  );
}

export function ReduxTag() {
  return (
    <div
      className="skill-tag"
      style={{ color: "white", backgroundColor: "#764ABC" }}
    >
      <img src="https://cdn.simpleicons.org/redux/FFFFFF?viewbox=auto&size=20" />
      Redux
    </div>
  );
}
